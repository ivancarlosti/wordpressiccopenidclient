...
return array(
    ...
    'ICC_OpenID_Client_Login_Form' => $baseDir . '/includes/icc-openid-client-login-form.php',
    'ICC_OpenID_Client_Option_Logger' => $baseDir . '/includes/icc-openid-client-option-logger.php',
    'ICC_OpenID_Client_Option_Settings' => $baseDir . '/includes/icc-openid-client-option-settings.php',
    'ICC_OpenID_Client_Settings_Page' => $baseDir . '/includes/icc-openid-client-settings-page.php',
);
