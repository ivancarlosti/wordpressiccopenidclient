 ...
 * @property int    $login_button_logo    The WordPress media attachment ID for the logo shown before the login button text.
 ...
 */
class ICC_GG_Sign_In_OpenID_Connect_Option_Settings {
	 ...
	 * @var string
	 */
	const OPTION_NAME = 'icc_gg_sign_in_openid_connect_settings';
