...
A simple client that provides SSO or opt-in authentication against a generic OAuth2 Server implementation, with email domain restriction support.
...
**New: Email Domain Restriction** — Restrict login to specific email domains (e.g., only users from "company.com" and "partner.org"). Leave empty to allow all domains.
...
1. Visit Settings > ICC OpenID Client and configure to meet your needs
